...
sudo apt update -y
sudo apt upgrade -y
sudo apt autoremove -y -> remove pacotes
sudo apt install build-essential -y -> instala pacote 
...
Cole os dados do local_settings.py.
...
python manage.py createsuperuser (bvcomdigital - ! v....@2)
```
